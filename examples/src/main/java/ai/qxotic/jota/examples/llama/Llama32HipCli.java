...
public final class Llama32HipCli {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!Environment.current().runtimes().hasRuntime(Device.HIP)) {
            throw new IllegalStateException(
                    "HIP runtime is not available. Build/load jota-runtime-hip and ROCm/HIP runtime first.");
        }
        Environment env =
                new Environment(
                        Device.HIP,
    ...
    private static final class Llama32Model {
        ...
        private static final boolean USE_C_GEMV =
                Boolean.parseBoolean(System.getProperty("ai.qxotic.llama.cgemv", "false"));
