...
class SmolLm3ToolIT extends AbstractToolIT {
     ...
     *
     * <p>The template matches the checkpoint's own Jinja wire, tool-result turn included, and every
     * other family passes the shared test. The assertion stays strict where it holds.
     */
    @Override
    void jsonToolResult() {
