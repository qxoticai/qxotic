...
public final class Lfm2CacheRun {
    public static void main(String[] args) throws Exception {
        ...
        Harness<Lfm2.State> h = new Harness<>(Lfm2.loadModel(path, 4096), path, 4096, false);   // MoE: threaded decode is not byte-deterministic
        new CacheScenario<>(h, CacheScenario.Config.of("You are a concise assistant.", 120)).run("Lfm2CacheRun");
    }
}
