...
class Lfm2ResetIdentityTest {
    ...
    void resetStateGeneratesByteIdenticallyToFresh() throws Exception {
        ...
        Lfm2 model = Lfm2.loadModel(ModelFixture.LFM25_350M_Q8.path(), 1024);
        ...
        Lfm2.State recycled = new Lfm2.State(model.config(), 1024, 64);
        ...
        Lfm2.State fresh = new Lfm2.State(model.config(), 1024, 64);
    ...
    private static IntSequence generate(Lfm2 model, Lfm2.State state, IntSequence prompt) {
