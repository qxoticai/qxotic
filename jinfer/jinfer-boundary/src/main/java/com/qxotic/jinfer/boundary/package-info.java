 ...
 *
 * <p>{@link com.qxotic.jinfer.boundary.Model} binds immutable configuration and weights to a
 * mutable {@link com.qxotic.jinfer.boundary.RuntimeState}. Context models add bounded, incremental
 * ingestion; language, embedding, reranking and speech interfaces add only their model-specific
 * projection.
 *
 * <p>States are single serial pipelines. Public model operations hold {@link
 * com.qxotic.jinfer.boundary.RuntimeState#exclusively(java.lang.Runnable) exclusive access}; a
