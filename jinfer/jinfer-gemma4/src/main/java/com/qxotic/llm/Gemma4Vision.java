// Gemma 4 vision encoder (gemma4v SigLIP-style ViT) against the new com.qxotic.llm API, with a
// BATCHED
...
public final class Gemma4Vision implements Embedder<Media.Image> {
    ...
    private FloatTensor
            clampScratch; // reused input-clamp buffer (lazily grown); avoids a per-call allocation
    ...
    private void feedForward(
            FloatTensor x, FloatTensor g, FloatTensor u, FloatTensor out, Layer l, int n) {
