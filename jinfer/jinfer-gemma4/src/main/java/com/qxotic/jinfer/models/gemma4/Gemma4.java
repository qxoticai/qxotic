// Gemma 4 against the com.qxotic.jinfer.models model API: a faithful port of the production jinfer
// Gemma4
...
public final class Gemma4
     ...
     */
    public Gemma4 attachMediaEncoders(Path mmprojGguf, Arena arena) throws IOException {
