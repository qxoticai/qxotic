...
// decode through the new com.qxotic.llm.Model seam (newState → ingest(prefill) → logits → ingest(step)).
//   java ... com.qxotic.llm.GemmaRun [model.gguf] [prompt] [nTokens]
...
public final class GemmaRun {
    public static void main(String[] args) throws Exception {
        ...
        int contextCapacity = args.length > 3 ? Integer.parseInt(args[3]) : -1;   // -1 → full model context
