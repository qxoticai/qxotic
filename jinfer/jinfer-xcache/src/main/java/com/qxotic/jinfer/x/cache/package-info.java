/**
 * Context caching behind one production entry point: {@link com.qxotic.jinfer.x.cache.PromptCache}.
 *
 ...
 * com.qxotic.jinfer.x.cache.CachedSession}, {@link com.qxotic.jinfer.x.cache.BlockTree} and {@link
 * com.qxotic.jinfer.x.cache.FrozenBlocks} are low-level building blocks for tests, benchmarks and
