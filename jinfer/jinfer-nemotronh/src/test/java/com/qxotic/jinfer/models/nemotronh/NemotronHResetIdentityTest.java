...
class NemotronHResetIdentityTest {
    ...
    void resetStateGeneratesByteIdenticallyToFresh() throws Exception {
        ...
        NemotronH model = NemotronH.loadModel(ModelFixture.NEMOTRON_30B_Q8.path(), 1024);
        ...
        NemotronH.State recycled = new NemotronH.State(model.config(), 1024, 64);
        ...
        NemotronH.State fresh = new NemotronH.State(model.config(), 1024, 64);
