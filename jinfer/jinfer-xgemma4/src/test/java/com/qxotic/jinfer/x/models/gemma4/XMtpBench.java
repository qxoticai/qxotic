// MTP benchmark, x tree: plain greedy vs speculative decode at depths 1..3, across prompt types
...
//   mvn test -pl jinfer-xgemma4 -Dtest=XMtpBench -Dsurefire.excludedGroups= \
...
class XMtpBench {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Case c : cases) {
            int[] ids = XGemma4MtpIdentityTest.withBos(bos, tk.encode(c.prompt).toList());
