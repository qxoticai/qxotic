 ...
 * construction; blocks match completely or not at all (blocks are self-contained; every boundary is
 * a resume point); every miss degrades to recompute, never to a wrong answer.
 *
