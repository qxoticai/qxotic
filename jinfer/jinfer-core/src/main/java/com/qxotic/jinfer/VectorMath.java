...
/**
 * Public SIMD primitives over contiguous {@code float[]} ranges, for model ports that live outside this
 * package (e.g. the gated-delta-net recurrence in {@code com.qxotic.llm.Qwen35}) and so cannot reach
 * {@link FloatTensor}'s package-private {@code F_SPECIES}/{@code USE_VECTOR_API}. Same vector path
 * {@link FloatTensor} uses, with a scalar fallback.
 */
