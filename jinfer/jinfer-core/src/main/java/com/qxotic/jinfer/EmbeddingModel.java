 ...
 * which projects a non-text modality into model-dim input rows — this consumes tokens and outputs
 * an embedding.
 *
 ...
 * exactly as {@code logits} projects it — the two are the same computation up to the head.
 */
public interface EmbeddingModel<C extends Config, W, S extends RuntimeState>
    ...
    /**
     * Embed packed ragged sequences (see {@link Batch.Input.Sequences}). Ingests the packed stream
