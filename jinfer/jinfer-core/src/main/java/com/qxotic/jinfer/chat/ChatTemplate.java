...
/**
 * The universal chat contract: lower a whole conversation to ingest-ready batches — text as {@link
 * Batch.Input.Tokens}, media as encoder-projected {@link Batch.Input.Embeddings}. Stateless and
 * deterministic: the same conversation must always produce the same batches (the prompt cache keys
 * on them).
 *
