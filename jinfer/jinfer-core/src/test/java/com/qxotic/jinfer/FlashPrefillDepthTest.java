...
class FlashPrefillDepthTest {
    ...
    static F32FloatTensor rnd(int size, long seed) {
        F32FloatTensor t = F32FloatTensor.allocate(Arena.ofAuto(), size);
        long x = seed;
    ...
    void chunkedAtDepthEqualsSingleShotWithinUlps() {
        ...
        F32FloatTensor empty = F32FloatTensor.allocate(Arena.ofAuto(), 1);

        F32FloatTensor outSingle = F32FloatTensor.allocate(Arena.ofAuto(), n * Q_STRIDE);
        ...
        F32FloatTensor outPrefix = F32FloatTensor.allocate(Arena.ofAuto(), n * Q_STRIDE);
        prefill(q, outPrefix, empty, empty, k, v, 0, p);
        F32FloatTensor qTail = F32FloatTensor.allocate(Arena.ofAuto(), tail * Q_STRIDE);
        F32FloatTensor kTail = F32FloatTensor.allocate(Arena.ofAuto(), tail * KV_DIM);
        F32FloatTensor vTail = F32FloatTensor.allocate(Arena.ofAuto(), tail * KV_DIM);
        ...
        F32FloatTensor outTail = F32FloatTensor.allocate(Arena.ofAuto(), tail * Q_STRIDE);
    ...
    void decodeMatchesFtzWidening() {
        ...
        FloatTensor f16 = FloatTensor.allocateF16(Arena.ofAuto(), keys, KV_DIM);
        ...
        F32FloatTensor dst = F32FloatTensor.allocate(Arena.ofAuto(), keys * headSize);
    ...
    void f16CacheEqualsWidenedF32Cache() {
        ...
        FloatTensor cK16 = FloatTensor.allocateF16(Arena.ofAuto(), p, KV_DIM);
        FloatTensor cV16 = FloatTensor.allocateF16(Arena.ofAuto(), p, KV_DIM);
        F32FloatTensor cK32 = F32FloatTensor.allocate(Arena.ofAuto(), p * KV_DIM);
        F32FloatTensor cV32 = F32FloatTensor.allocate(Arena.ofAuto(), p * KV_DIM);
        ...
        F32FloatTensor out16 = F32FloatTensor.allocate(Arena.ofAuto(), tail * Q_STRIDE);
        F32FloatTensor out32 = F32FloatTensor.allocate(Arena.ofAuto(), tail * Q_STRIDE);
        FlashAttention.slidingWindowPrefill(
    ...
    void depthCurve() {
        ...
        for (boolean f16 : new boolean[] {false, true}) {
            for (int depth : new int[] {0, 1216}) {
                ...
                FloatTensor cK =
                        f16
                                ? FloatTensor.allocateF16(Arena.ofAuto(), n, kvDim)
                                : rnd(n * kvDim, 10);
                FloatTensor cV =
                        f16
                                ? FloatTensor.allocateF16(Arena.ofAuto(), n, kvDim)
                ...
                F32FloatTensor out = F32FloatTensor.allocate(Arena.ofAuto(), tail * qStride);
                Runnable one =
                        () ->
                                FlashAttention.slidingWindowPrefill(
                                        q,
