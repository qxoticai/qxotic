...
/**
 * Statically links liblfm25jni.a (AVX-512 GEMM) into the native image: native methods in
 * com.llama4j.* bind to the direct JNI-mangled exports at image link time — no System.loadLibrary.
...
public class LFM25StaticGemmFeature implements Feature {
    ...
    public void duringSetup(DuringSetupAccess access) {
        PlatformNativeLibrarySupport.singleton().addBuiltinPkgNativePrefix("com_llama4j");
    }

    @Override
    public void beforeAnalysis(BeforeAnalysisAccess access) {
        NativeLibraries nl = ((FeatureImpl.BeforeAnalysisAccessImpl) access).getNativeLibraries();
        nl.addStaticJniLibrary("lfm25jni");
    }
}
