 ...
 * @param contextCapacity upper bound on the encoded query-and-document context (default 2048);
 *     {@code 0} uses the model's {@code maxContextLength}; negative values are rejected
