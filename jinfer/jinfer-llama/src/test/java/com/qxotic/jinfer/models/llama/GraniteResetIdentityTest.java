 ...
 */
@Tag("integration")
class GraniteResetIdentityTest {
    ...
    void resetStateGeneratesByteIdenticallyToFresh() throws Exception {
        ...
        Granite model = Granite.loadModel(ModelFixture.GRANITE_41_3B_Q8.path(), Arena.ofAuto());
    ...
    private static IntSequence generate(Granite model, Granite.State state, IntSequence prompt) {
