...
public final class Inflect2 {
    ...
    //
    // The x port resolves dtype at load: every element-accessed tensor (embedding, relative
     ...
     * as {@link com.qxotic.jinfer.x.boundary.Model}: {@code ofAuto} is GC-managed, {@code global}
    ...
    private Media.Audio synthesize0(
        ...
        MemoryView<MemorySegment> waveform =
                Parallel.onDecodePool(() -> decode(state, flowed, frames));
