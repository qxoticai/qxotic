...
public enum MetadataValueType {
    ...
    FLOAT32(4),
    /**
     * The value is a boolean. 1-byte value where 0 is false and 1 is true. Anything else is
     * invalid, and should be treated as either the model being invalid or the reader being buggy.
     */
    BOOL(1),
    /** The value is a UTF-8 non-null-terminated string, with length prepended. */
    STRING(-8),
    /**
     * The value is an array of other values, with the length and type prepended. Arrays can be
     * nested, and the length of the array is the number of elements in the array, not the number of
     * bytes.
     */
    ARRAY(-8),
     ...
     *
     * @param byteSize the size in bytes for this type. Positive for fixed-size types, negative for
     *     variable-length types indicating the size of their length prefix
     */
     ...
     *
     * @return for fixed-size types, returns the positive size in bytes; for variable-length types,
