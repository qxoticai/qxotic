...
class Llama3TokenizerTest extends TokenizerTest {
    ...
    private IntSequence encode(Llama3ChatFormat chatFormat, String text, boolean prependBOS, boolean appendEOS) {
    ...
    void testEncodeMessage(Llama3ChatFormat chatFormat) {
        Llama3ChatFormat.Message message = new Llama3ChatFormat.Message(ChatFormat.USER, "This is a test sentence.");
    ...
    void testEncodeDialog(Llama3ChatFormat chatFormat) {
        List<Llama3ChatFormat.Message> messages = List.of(
