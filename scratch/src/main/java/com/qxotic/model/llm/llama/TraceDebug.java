...
public final class TraceDebug {
    private static final boolean ENABLED = Boolean.getBoolean("com.qxotic.trace");
    private static final int TOKEN_LIMIT = Integer.getInteger("com.qxotic.trace.tokenLimit", 8);
