...
/**
 * Large file benchmark for testing tokenizer performance on the enwik9 dataset. This benchmark
 * measures encoding and decoding throughput on a ~1GB file.
 *
 * <p>Note: Due to Java array size limitations (Integer.MAX_VALUE), we process the file in chunks
