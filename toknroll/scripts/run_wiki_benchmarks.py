...
Examples:
  ...
  python scripts/run_wiki_benchmarks.py --corpus enwik8 --parallel true --modes encode,decode
  python scripts/run_wiki_benchmarks.py --corpus enwik8 --parallel false --encodings r50k_base,cl100k_base,o200k_base
"""
