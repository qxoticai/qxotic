...
class MistralTokenizerTest extends TokenizerTest {
    ...
    //        MistralChatFormat.Message message = new
    // MistralChatFormat.Message(MistralChatFormat.Role.USER, "This is a test sentence.");
    //
    ...
    //                new MistralChatFormat.Message(MistralChatFormat.Role.SYSTEM, "This is a test
    // sentence."),
    //                new MistralChatFormat.Message(MistralChatFormat.Role.USER, "This is a
    // response.")
    //        );
    //
    //        IntSequence expected = IntSequence.of(
