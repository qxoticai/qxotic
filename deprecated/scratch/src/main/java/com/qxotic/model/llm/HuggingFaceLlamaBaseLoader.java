...
public class HuggingFaceLlamaBaseLoader
    ...
    //        return tensors.stream().collect(Collectors.toMap(TensorEntry::name,
    // Function.identity()));
    //    }
    //
    //    public static void main(String[] args) throws IOException {
    //        Path modelRoot =
    // Path.of("/home/mukel/Desktop/playground/models/hf/Llama-3.2-1B-Instruct");
    ...
    //        try (var fileChannel =
    //                FileChannel.open(modelRoot.resolve("model.safetensors"),
    ...
    //    //            throw new IllegalArgumentException(tokenizerBinPath + " not found, please
    // convert
    ...
    //    //    }
    //    //
    //    //    static FloatBuffer[] loadArrayOfFloatBuffersRearrangeHuggingFace(Llama2.Config
    // config, int
    //    // size, IntFunction<TensorEntry> getTensorEntry) {
    //    //        ByteBuffer[] byteBuffers = loadArrayOfByteBuffersRearrangeHuggingFace(config,
    // size,
    //    // getTensorEntry);
    ...
    //    //    }
    //
    //    //    static ByteBuffer[] loadArrayOfByteBuffersRearrangeHuggingFace(Llama2.Config config,
    // int
    //    // size, IntFunction<TensorEntry> getTensorEntry) {
    ...
    //    //    }
    //    //
    //    //    static FloatTensor[] loadArrayOfFloatsRearrangeHuggingFace(Llama2.Config config, int
    // size,
    ...
    //    //            floats[i] = new F32FloatTensor(size,
    // MemorySegment.ofBuffer(byteBuffers[i]));
    //    //        }
    //    //        return floats;
    //    //    }
    //    //
    ...
    //    public Llama loadModel(Llama.Configuration configuration) {
    //        return new Llama(
    //                configuration, DefaultKernelOps.getKernelOps(),
    // DefaultKernelOps.getSpanFactory());
    //    }
    //
    //    public ChatFormat createChatFormat(Tokenizer tokenizer) {
    ...
    //                true,
    //                ((Number) modelConfig.getOrDefault("attention_multiplier",
    // Float.NaN)).floatValue(),
    //                ((Number) modelConfig.getOrDefault("residual_multiplier",
    // Float.NaN)).floatValue(),
    //                ((Number) modelConfig.getOrDefault("logits_scaling", Float.NaN)).floatValue(),
    //                ((Number) modelConfig.getOrDefault("embedding_multiplier",
    // Float.NaN)).floatValue(),
    //                FloatUnaryOperator.SILU,
    //                null);
    //    }
    //
    //    static Pair<Path, TensorEntry> getTensorEntry(Map<Path, Safetensors> cache, String
    // tensorName) {
    //
    // cache.computeIfAbsent(safetensorsIndex.getSafetensorsPath("model.embed_tokens.weight"), path
    ...
    //                            ? tensorAsMatrix(
    //                                    safetensorsIndex.getTensor("lm_head.weight"), spanLoader,
    // true)
    //                            : tokenEmbeddings;
    //
    ...
    //                            true,
    //                            config.numberOfLayers,
    //                            i -> safetensorsIndex.getTensor("blk." + i +
    // ".attn_q_norm.weight"),
    //                            spanLoader),
    //                    loadSpanArray(
    //                            true,
    ...
    //                    loadMatrixArray(
    //                            config.numberOfLayers,
    //                            i -> safetensorsIndex.getTensor("model.layers." + i +
    // ".mlp.up_proj.weight"),
    //                            spanLoader),
    ...
    //    }
    //
    //    public static FloatMatrixView tensorAsMatrix(TensorEntry tensorInfo, SpanLoader
    // spanLoader) {
    ...
    //        // return IntStream.range(0,
    //        // size).mapToObj(getTensorEntry).map(spanLoader).toArray(FloatSpan[]::new);
    //        FloatSpan[] array = null; // Lazily allocated if there's at it contains at least one
    // entry.
    //        for (int i = 0; i < size; i++) {
    //            TensorEntry tensorInfo = getTensorEntry.apply(i);
    //            if (tensorInfo != null) {
