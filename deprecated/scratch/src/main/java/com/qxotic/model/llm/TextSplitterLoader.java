...
import com.qxotic.model.llm.apertus.TekkenTextSplitterFactory;
import com.qxotic.model.llm.generic.DBRXTextSplitterFactory;
import com.qxotic.model.llm.generic.DefaultTextSplitterFactory;
import com.qxotic.model.llm.granite.RefactTextSplitterFactory;
...
public class TextSplitterLoader {
    ...
    public Splitter loadTextSplitter(GGUF gguf) {
