...
/**
 * Represents a view or slice over a contiguous sequence of float values.
 * This interface extends the generic Span interface specifically for Float data types,
 * providing specialized methods for working with floating-point number sequences.
 * The span acts as a window over the underlying data without copying it.
 */
public interface FloatSpan extends Span<Float> {

    /**
     * Creates a new FloatSpan representing a subsection of this span.
