...
class IntSequencesTest {
    ...
    void concatAllHandlesEmptyAndNulls() {
        ...
        assertThrows(NullPointerException.class, () -> IntSequences.concatAll((IntSequence[]) null));
        assertThrows(
    ...
    void concatAndConcatAllProduceExpectedOrder() {
        IntSequence merged = IntSequences.concat(IntSequence.of(1), IntSequence.of(2), IntSequence.of(3, 4));
        assertArrayEquals(new int[] {1, 2, 3, 4}, merged.toArray());

        IntSequence mergedAll = IntSequences.concatAll(IntSequence.of(5), IntSequence.of(), IntSequence.of(6));
        assertArrayEquals(new int[] {5, 6}, mergedAll.toArray());
    }

    @Test
    void concatRejectsNullInputs() {
        assertThrows(NullPointerException.class, () -> IntSequences.concat(null, IntSequence.of(1)));
        assertThrows(NullPointerException.class, () -> IntSequences.concat(IntSequence.of(1), null));
        assertThrows(
                NullPointerException.class,
                () -> IntSequences.concat(IntSequence.of(1), IntSequence.of(2), (IntSequence[]) null));
        assertThrows(
                NullPointerException.class,
                () -> IntSequences.concat(IntSequence.of(1), IntSequence.of(2), null));
    }
    ...
    void contentEqualsCoversEqualAndDifferentShapes() {
        ...
        assertThrows(NullPointerException.class, () -> IntSequences.contentEquals(null, IntSequence.of(1)));
        assertThrows(NullPointerException.class, () -> IntSequences.contentEquals(IntSequence.of(1), null));
    }
    ...
    void compareIsLexicographicAndOverflowSafe() {
        ...
        assertTrue(
                IntSequences.compare(IntSequence.of(Integer.MIN_VALUE), IntSequence.of(Integer.MAX_VALUE))
                        < 0);

        assertThrows(NullPointerException.class, () -> IntSequences.compare(null, IntSequence.of(1)));
        assertThrows(NullPointerException.class, () -> IntSequences.compare(IntSequence.of(1), null));
    }
}
