...
public class TestNativeGPT2 {
    ...
    private static final String OUTPUT_PATH = "/home/mukel/Desktop/playground/llm4j/tokenizers/java_tokens_1mb.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String text = new String(fileBytes, 0, Math.min(SAMPLE_SIZE, fileBytes.length), 
