...
public class SaveJavaTokens {
    ...
    private static final String OUTPUT_PATH = "/home/mukel/Desktop/playground/llm4j/tokenizers/java_tokens.txt";
    ...
    private static Tokenizer createR50KTokenizer() throws Exception {
        ...
        return Tiktoken.createFromTiktoken("r50k_base", mergeableRanks,
