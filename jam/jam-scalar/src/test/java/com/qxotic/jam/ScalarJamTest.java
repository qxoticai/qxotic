...
class ScalarJamTest {
    ...
    @Test void declinesUnsupported() {
        ...
        assertEquals(JAM.EUNSUPPORTED, jam.mm(d, 0, JAM.Q8_0, 32, d, 0, JAM.F32,  32, d, 0, JAM.BF16, 4, 4, 2, 32), "BF16 result declined");
    }
