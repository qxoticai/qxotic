...
class TensorCoreSemanticsTest {
    ...
    void bitwiseRequiresSameDtype() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> TensorOpsContext.with(new EagerTensorOps(domain), () -> left.bitwiseAnd(right)));
    }
    ...
    void numericOpsRejectBoolOperands() {
        ...
        Tensor compare =
                TensorOpsContext.with(new EagerTensorOps(domain), () -> left.equal(right));
