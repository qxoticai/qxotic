...
class HipMinMaxReductionTest {
    ...
    void reducesMinAndMaxOnHipBackend() {
        ...
        assertEquals(
                1.0f,
                access.readFloat(minAxis1.memory(), Indexing.linearToOffset(minAxis1, 0)),
                0.0001f);
        assertEquals(
                4.0f,
                access.readFloat(minAxis1.memory(), Indexing.linearToOffset(minAxis1, 1)),
                0.0001f);
        ...
        assertEquals(
                3.0f,
                access.readFloat(maxAxis1.memory(), Indexing.linearToOffset(maxAxis1, 0)),
                0.0001f);
        assertEquals(
                6.0f,
                access.readFloat(maxAxis1.memory(), Indexing.linearToOffset(maxAxis1, 1)),
                0.0001f);
        ...
        assertEquals(
                1.0f,
                access.readFloat(minAxis0.memory(), Indexing.linearToOffset(minAxis0, 0)),
                0.0001f);
        assertEquals(
                2.0f,
                access.readFloat(minAxis0.memory(), Indexing.linearToOffset(minAxis0, 1)),
                0.0001f);
        assertEquals(
                3.0f,
                access.readFloat(minAxis0.memory(), Indexing.linearToOffset(minAxis0, 2)),
                0.0001f);
        ...
        assertEquals(
                4.0f,
                access.readFloat(maxAxis0.memory(), Indexing.linearToOffset(maxAxis0, 0)),
                0.0001f);
        assertEquals(
                5.0f,
                access.readFloat(maxAxis0.memory(), Indexing.linearToOffset(maxAxis0, 1)),
                0.0001f);
        assertEquals(
                6.0f,
                access.readFloat(maxAxis0.memory(), Indexing.linearToOffset(maxAxis0, 2)),
                0.0001f);
        ...
        MemoryView<MemorySegment> hostOut =
                MemoryView.of(
                        host.memoryAllocator()
                                .allocateMemory(deviceOut.dataType(), deviceOut.shape().size()),
                        deviceOut.dataType(),
