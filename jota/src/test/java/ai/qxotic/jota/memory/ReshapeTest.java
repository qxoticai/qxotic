...
class ReshapeTest extends AbstractMemoryTest {
    ...
    void testReshapeAfterSlice() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.rowMajor(DataType.FP32, MemoryFactory.ofFloats(floats), Shape.of(2, 3, 5));
    ...
    void testReshapeContiguous() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.of(DataType.FP32, MemoryFactory.ofFloats(floats), Layout.rowMajor(Shape.of(2, 3, 4)));
    ...
    void testReshapeWithSingletons() {
        ...
        MemoryView<float[]> withSingletons = MemoryViewFactory.of(DataType.FP32, MemoryFactory.ofFloats(floats), Layout.rowMajor(Shape.of(1, 2, 3, 4, 1)));
    ...
    void testReshapeDimensionSplitting() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.of(DataType.FP32, MemoryFactory.ofFloats(floats), Layout.rowMajor(Shape.of(6, 4)));
    ...
    void testReshapeZeroDimensions() {
        ...
        MemoryView<float[]> scalar = MemoryViewFactory.of(DataType.FP32, MemoryFactory.ofFloats(floats), Layout.scalar());
    ...
    void testReshapeDataIntegrity() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.rowMajor(DataType.FP32, MemoryFactory.ofFloats(floats), Shape.of(3, 4));
        MemoryAccess<float[]> memoryAccess = MemoryAccessFactory.ofFloats();
    ...
    void testValidReshapeSameTotalElements() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.rowMajor(DataType.FP32, MemoryFactory.ofFloats(data), Shape.of(3, 4));
    ...
    void testReshapeEmptyView() {
        float[] emptyData = {};
        MemoryView<float[]> emptyView = MemoryViewFactory.rowMajor(DataType.FP32, MemoryFactory.ofFloats(emptyData), Shape.of(0));
    ...
    void testViewContiguous() {
        float[] floats = arange(2 * 3 * 4);
        MemoryView<float[]> view = MemoryViewFactory.rowMajor(DataType.FP32, MemoryFactory.ofFloats(floats), Shape.of(2, 3, 4));
