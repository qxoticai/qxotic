...
//
//
//            var memoryView = MemoryViewFactory.of(DataType.F32, memory, Layout.rowMajor(Shape.of(16)));
...
//            Memory<MemorySegment> memory = MemoryFactory.ofMemorySegment(memorySegment);
//            var memoryView = MemoryViewFactory.of(DataType.F32, memory, Layout.rowMajor(Shape.of(3, 5)));
//
//            assertTrue(memoryView.isContiguous());
//
//            var it = OffsetIterator.create(memoryView);
...
//    void testReshape() {
//        try (var arena = Arena.ofShared()) {
//            MemorySegment memorySegment = arena.allocate(DataType.F32.byteSizeFor(Shape.of(3, 5)));
//            Memory<MemorySegment> memory = MemoryFactory.ofMemorySegment(memorySegment);
//            var memoryView = MemoryViewFactory.of(DataType.F32, memory, Layout.rowMajor(3, 5));
//
//            assertTrue(memoryView.isContiguous());
//
//            var it = OffsetIterator.create(memoryView);
