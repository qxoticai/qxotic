...
import static com.llm4j.jota.memory.ReshapeTest.arange;
...
class PermuteTest {
    ...
    void testPermuteStridedContiguous() {
        ...
        assertArrayEquals(expectedStrides, permuted.byteStrides());
    ...
    void testPermuteStridedNonContiguous() {
        ...
        assertArrayEquals(new long[]{2 * 4, 10 * 4}, transposed.byteStrides());
    ...
    void testPermuteBroadcastedDimension() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.of(
                Shape.of(3, 4),    // NOT (3,1) - we want (3,4) with broadcasting
        ...
        assertArrayEquals(new long[]{0, 4 * 4}, permuted.byteStrides());
    }
    ...
    void testPermuteWithOffset() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.of(
                ...
                DataType.F32,
                10 * 4, // byteOffset = 10 floats * 4 bytes
                MemoryFactory.ofFloats(data)
        );
        ...
        assertArrayEquals(new long[]{4, 5 * 4}, transposed.byteStrides());
