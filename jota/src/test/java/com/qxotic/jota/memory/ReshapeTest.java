...
class ReshapeTest extends AbstractMemoryTest {
    ...
    void testReshapeAfterSlice() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.rowMajor(DataType.F32, MemoryFactory.ofFloats(floats), Shape.of(2, 3, 5));
    ...
    void testReshapeDataIntegrity() {
        ...
        MemoryView<float[]> view = MemoryViewFactory.rowMajor(DataType.F32, MemoryFactory.ofFloats(floats), Shape.of(3, 4));
        MemoryAccess<float[]> memoryAccess = MemoryAccessFactory.ofFloats();
