...
//        MemoryView<float[]> v = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(new float[6]), Shape.of(2, 3));
...
//        MemoryView<float[]> scalar = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(42f), Shape.scalar());
...
//        MemoryView<float[]> v = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(new float[4]), Shape.of(4, 1));
...
//        MemoryView<float[]> v = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(new float[12]), Shape.of(3, 1, 4));
//        assertFalse(v.isBroadcasted());
...
//        MemoryView<float[]> v = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(new float[5]), Shape.of(1, 5));
//        assertFalse(v.isBroadcasted());
...
//        MemoryView<float[]> v = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(new float[18]), Shape.of(3, 6));
...
//        MemoryView<float[]> scalar = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(7f), Shape.scalar());
...
//        MemoryView<float[]> empty = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(new float[0]), Shape.of(0));
//        MemoryView<float[]> result = empty.broadcast(Shape.of(3, 0));
//        assertEquals(Shape.of(3, 0), result.shape());
//        assertEquals(0, result.shape().size());
//    }
...
//        MemoryView<float[]> scalar = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(1f), Shape.scalar());
...
//        MemoryView<float[]> s = MemoryViewFactory.of(DataType.F32, MemoryFactory.ofFloats(1f), Shape.scalar());
