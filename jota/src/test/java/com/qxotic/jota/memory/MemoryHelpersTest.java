...
public class MemoryHelpersTest extends AbstractMemoryTest {
    ...
    <B> void testArangeExplicitDataTypeBool(MemoryContext<B> context) {
        MemoryView<B> view = MemoryHelpers.arange(context, DataType.BOOL, 2);
        assertEquals(2, view.shape().size());
        assertEquals(DataType.BOOL, view.dataType());
