...
class ReciprocalOpTest extends AbstractMemoryTest {
    ...
    void reciprocalPreservesDataType() {
        ...
        for (DataType dataType : floatingTypes) {
            if (dataType == DataType.FP32) {
                ...
                assertEquals(1.0f, readFloat(result, 0), 0.0001f);
                assertEquals(0.5f, readFloat(result, 1), 0.0001f);
                assertEquals(0.25f, readFloat(result, 2), 0.0001f);
                assertEquals(0.125f, readFloat(result, 3), 0.0001f);
                ...
                assertEquals(shape, output.shape());
                assertEquals(1.0, readDouble(result, 0), 0.0001);
                assertEquals(0.5, readDouble(result, 1), 0.0001);
                assertEquals(0.25, readDouble(result, 2), 0.0001);
                assertEquals(0.125, readDouble(result, 3), 0.0001);
            }
        }
    }
    ...
    void reciprocalWithFloatInput() {
        ...
        assertEquals(1.0f, readFloat(result, 0), 0.0001f);
        assertEquals(0.5f, readFloat(result, 1), 0.0001f);
        assertEquals(2.0f, readFloat(result, 2), 0.0001f);
        assertEquals(0.25f, readFloat(result, 3), 0.0001f);
    }
    ...
    void reciprocalWithSmallValues() {
        ...
        assertEquals(100.0f, readFloat(result, 1), 0.01f);
        assertEquals(4.0f, readFloat(result, 2), 0.0001f);
        assertEquals(2.0f, readFloat(result, 3), 0.0001f);
    }
    ...
    void reciprocalWithScalar() {
        ...
        assertEquals(0.2f, readFloat(result, 0), 0.0001f);
    }
    ...
    void reciprocalWithTargetDataTypeFromFP32ToFP64() {
        ...
        assertEquals(DataType.FP64, output.dataType());
        assertEquals(0.5, readDouble(result, 0), 0.001);
        assertEquals(0.25, readDouble(result, 1), 0.001);
    }
    ...
    void reciprocalInComplexExpression() {
        ...
        assertEquals(1.5f, readFloat(result, 1), 0.0001f);
        assertEquals(1.25f, readFloat(result, 2), 0.0001f);
        assertEquals(1.125f, readFloat(result, 3), 0.0001f);
    }
    ...
    private float readFloat(Tensor tensor, long linearIndex) {
        return TensorTestReads.readFloat(tensor, linearIndex);
    }

    private double readDouble(Tensor tensor, long linearIndex) {
