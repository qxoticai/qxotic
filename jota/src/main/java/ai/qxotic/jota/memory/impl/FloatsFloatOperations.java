...
final class FloatsFloatOperations implements FloatOperations<float[]> {
    ...
    public void elementWise(
            MemoryView<float[]> in, FloatUnaryOperator unaryOperator, MemoryView<float[]> out) {
    ...
    @Override
    public void elementWise(
            float scalar, FloatUnaryOperator unaryOperator, MemoryView<float[]> out) {
        if (out.dataType() != DataType.FP32) {
            throw new UnsupportedOperationException(
                    "Unsupported (out) data type: " + out.dataType());
        }
    ...
    public void elementWise2(
            MemoryView<float[]> left,
            FloatBinaryOperator binaryOperator,
            MemoryView<float[]> right,
            MemoryView<float[]> out) {
    ...
    @Override
    public float foldAll(
            MemoryView<float[]> in, float initialValue, FloatBinaryOperator binaryOperator) {
        if (in.dataType() != DataType.FP32) {
            throw new UnsupportedOperationException("Unsupported data type: " + in.dataType());
        }
        float accumulator = initialValue;
    ...
    public void matrixMultiply(
            MemoryView<float[]> left, MemoryView<float[]> right, MemoryView<float[]> out) {
        throw new UnsupportedOperationException();
    }
}
