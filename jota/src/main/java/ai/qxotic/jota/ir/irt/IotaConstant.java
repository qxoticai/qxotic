 ...
 */
public record IotaConstant(long count, DataType dataType, Layout layout) implements IRTNode {
    ...
    public static IotaConstant of(long count, DataType dtype) {
        return new IotaConstant(count, dtype, Layout.rowMajor(count));
    }
}
