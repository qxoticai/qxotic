...
public record TiledLoop(
        String outerName, String innerName, IndexExpr totalBound, long tileSize, IRLNode body)
        implements IRLNode {
    ...
    public static TiledLoop of(
            String outerName, String innerName, long totalBound, long tileSize, IRLNode body) {
