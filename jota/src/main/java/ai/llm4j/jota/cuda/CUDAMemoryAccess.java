...
public class CUDAMemoryAccess implements MemoryAccess<CUdeviceptr> {
    ...
    public byte readByte(Memory<CUdeviceptr> memory, long byteOffset) {
        ...
        int result =
                JCudaDriver.cuMemcpyDtoH(
                        Pointer.to(hostBuffer), memory.base().withByteOffset(byteOffset), 1);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from device to host: " + CUresult.stringFor(result));
        }
        return hostBuffer[0];
    }
    ...
    public void writeByte(Memory<CUdeviceptr> memory, long byteOffset, byte value) {
        ...
        int result =
                JCudaDriver.cuMemcpyHtoD(
                        memory.base().withByteOffset(byteOffset), Pointer.to(hostBuffer), 1);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from host to device: " + CUresult.stringFor(result));
        }
    }
    ...
    public short readShort(Memory<CUdeviceptr> memory, long byteOffset) {
        ...
        int result =
                JCudaDriver.cuMemcpyDtoH(
                        Pointer.to(hostBuffer), memory.base().withByteOffset(byteOffset), 2);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from device to host: " + CUresult.stringFor(result));
        }
    ...
    public void writeShort(Memory<CUdeviceptr> memory, long byteOffset, short value) {
        ...
        int result =
                JCudaDriver.cuMemcpyHtoD(
                        memory.base().withByteOffset(byteOffset), Pointer.to(hostBuffer), 2);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from host to device: " + CUresult.stringFor(result));
        }
    ...
    public int readInt(Memory<CUdeviceptr> memory, long byteOffset) {
        ...
        int result =
                JCudaDriver.cuMemcpyDtoH(
                        Pointer.to(hostBuffer), memory.base().withByteOffset(byteOffset), 4);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from device to host: " + CUresult.stringFor(result));
        }
    ...
    public void writeInt(Memory<CUdeviceptr> memory, long byteOffset, int value) {
        ...
        int result =
                JCudaDriver.cuMemcpyHtoD(
                        memory.base().withByteOffset(byteOffset), Pointer.to(hostBuffer), 4);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from host to device: " + CUresult.stringFor(result));
        }
    ...
    public long readLong(Memory<CUdeviceptr> memory, long byteOffset) {
        ...
        int result =
                JCudaDriver.cuMemcpyDtoH(
                        Pointer.to(hostBuffer), memory.base().withByteOffset(byteOffset), 8);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from device to host: " + CUresult.stringFor(result));
        }
    ...
    public void writeLong(Memory<CUdeviceptr> memory, long byteOffset, long value) {
        ...
        int result =
                JCudaDriver.cuMemcpyHtoD(
                        memory.base().withByteOffset(byteOffset), Pointer.to(hostBuffer), 8);
        if (result != CUresult.CUDA_SUCCESS) {
            throw new RuntimeException(
                    "Failed to copy memory from host to device: " + CUresult.stringFor(result));
        }
