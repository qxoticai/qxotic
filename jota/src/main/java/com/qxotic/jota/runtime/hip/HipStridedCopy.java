...
final class HipStridedCopy {

    private static final HipKernelBackend BACKEND = new HipKernelBackend();
    private static final ConcurrentMap<String, KernelExecutable> CACHE = new ConcurrentHashMap<>();

    private HipStridedCopy() {}

    static void copy(MemoryView<HipDevicePtr> src, MemoryView<HipDevicePtr> dst) {
                ...
                CACHE.computeIfAbsent(
                        ...
                        id -> {
                            ...
                            KernelProgram program =
                                    KernelProgram.source("hip", source, "strided_copy");
    ...
    private static String generateKernel(int rank, int elemBytes) {
        ...
        sb.append("#include <hip/hip_runtime.h>\n\n");
