...
class ReshapeTest extends AbstractMemoryTest {
    ...
    void testReshapeAfterSlice() {
        ...
        MemoryView<float[]> view =
                MemoryViews.rowMajor(Memories.of(floats), DataType.FP32, Shape.of(2, 3, 5));
    ...
    void testReshapeContiguous() {
        ...
        MemoryView<float[]> view =
                MemoryViews.of(
                        Memories.of(floats), DataType.FP32, Layout.rowMajor(Shape.of(2, 3, 4)));
    ...
    void testReshapeDimensionSplitting() {
        ...
        MemoryView<float[]> view =
                MemoryViews.of(Memories.of(floats), DataType.FP32, Layout.rowMajor(Shape.of(6, 4)));
    ...
    void viewCuTeStartsAtTheBeginningOfANegativeStrideSpan() {
        ...
        MemoryAccess<float[]> access = MemoryDomains.floats().directAccess();
        for (int i = 0; i < 6; i++) {
    ...
    void testReshapeZeroDimensions() {
        ...
        MemoryView<float[]> scalar =
                MemoryViews.of(Memories.of(floats), DataType.FP32, Layout.scalar());
    ...
    void testReshapeDataIntegrity() {
        ...
        MemoryView<float[]> view =
                MemoryViews.rowMajor(Memories.of(floats), DataType.FP32, Shape.of(3, 4));
        MemoryAccess<float[]> memoryAccess = MemoryDomains.floats().directAccess();
    ...
    void testValidReshapeSameTotalElements() {
        ...
        MemoryView<float[]> view =
                MemoryViews.rowMajor(Memories.of(data), DataType.FP32, Shape.of(3, 4));
    ...
    void testReshapeEmptyView() {
        ...
        MemoryView<float[]> emptyView =
                MemoryViews.rowMajor(Memories.of(emptyData), DataType.FP32, Shape.of(0));
    ...
    void testViewContiguous() {
        float[] floats = arange(2 * 3 * 4);
        MemoryView<float[]> view =
                MemoryViews.rowMajor(Memories.of(floats), DataType.FP32, Shape.of(2, 3, 4));
