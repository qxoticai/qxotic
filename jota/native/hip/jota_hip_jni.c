...
JNIEXPORT jlong JNICALL Java_ai_qxotic_jota_hip_HipRuntime_createStream
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipRuntime_destroyStream
...
JNIEXPORT jlong JNICALL Java_ai_qxotic_jota_hip_HipRuntime_loadModule
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipRuntime_unloadModule
...
JNIEXPORT jlong JNICALL Java_ai_qxotic_jota_hip_HipRuntime_getFunction
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipRuntime_launchKernel
...
JNIEXPORT jlong JNICALL Java_ai_qxotic_jota_hip_HipRuntime_malloc
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipRuntime_free
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipRuntime_memcpyHtoD
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipRuntime_memcpyDtoH
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipRuntime_memcpyDtoD
...
JNIEXPORT jlong JNICALL Java_ai_qxotic_jota_hip_HipKernelParams_packNative
  ...
  jclass hipDevicePtrClass = findClass(env, "ai/qxotic/jota/hip/HipDevicePtr");
  ...
  jmethodID intValueMid = getMethod(env, numberClass, "intValue", "()I");
  jmethodID floatValueMid = getMethod(env, numberClass, "floatValue", "()F");
  jmethodID doubleValueMid = getMethod(env, numberClass, "doubleValue", "()D");
  ...
  for (jint i = 0; i < size; i++) {
    ...
    if (kindOrdinal == 1) {
      ...
      if (strcmp(nameChars, "bool") == 0 || strcmp(nameChars, "boolean") == 0) {
        jint v = (*env)->CallIntMethod(env, valueObj, intValueMid);
        ...
        *storage = (int32_t)v;
        ...
        jlong v = (*env)->CallLongMethod(env, valueObj, longValueMid);
        ...
        *storage = (uint16_t)v;
        ...
        jfloat v = (*env)->CallFloatMethod(env, valueObj, floatValueMid);
        ...
        *storage = (float)v;
        ...
        jdouble v = (*env)->CallDoubleMethod(env, valueObj, doubleValueMid);
...
JNIEXPORT void JNICALL Java_ai_qxotic_jota_hip_HipKernelParams_releaseNative
  (JNIEnv *env, jclass cls, jlong handle) {
  (void)env;
  (void)cls;
